<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bar-chart"></i> <span>Dashboard</span></a></li>
        <li><a href="enquiry/views/welcome_enquiry.php"><i class="fa fa-book"></i> <span>Enquiry / BDE</span></a></li>
        <li><a href="billing/views/welcome_bill.php"><i class="fa fa-dollar"></i> <span>Finance </span></a></li>
        <li class="treeview"> <a href="#"><i class="fa fa-cog"></i> <span>Settings</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu" >
            ...
            <li><a href="setting/views/change_password.php" ><i class="fa fa-circle-o-notch"></i><span style="font-size:12px;">Change Password</span></a></li>
            
          </ul>
        </li>
        <li><a href="reports/views/index.php"><i class="fa fa-book"></i> <span>Client Report</span></a></li>
