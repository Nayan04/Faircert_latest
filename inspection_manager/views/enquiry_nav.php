<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header"><i class="fa fa-bar-chart"></i> inspection Manager Operation</li>
        ...
        <li <?php if($page==4.5){?>class="active"<?php } ?>> <a href="forwarded_enquiry.php"><i class="fa fa-eye"></i> <span> Working Enquiry</span></a>
         </li>
