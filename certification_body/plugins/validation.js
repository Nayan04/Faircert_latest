...
$("#oncertification").hide();
function get_cert_status(){
	var status=$("#status option:selected").val();
	//alert(status)
	if(status=='certification decision on client file by certification committe and generate scope document'){
		$("#oncertification").show();
	}else{
		$("#oncertification").hide();
		//$("#cert_status").val
...
function change_status(){ 
    ...
    var status = $('#status option:selected').val();
	var cert_status = $('#cert_status option:selected').val();
    var enq_id = $('#enq').val();
    //-----------------------------------//
    ...
    if (yess) {
        var dataString = 'status=' + status + '&remark=' + remark + '&enq_id=' + enq_id + '&cert_status='+cert_status;
        //alert(dataString)
