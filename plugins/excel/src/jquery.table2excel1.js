		...
		init: function () {
			...
			$(e.element).each( function(i,o) {
				var tempRows = "";
                                colCount=colCount;
                                var co=0;
                                tempRows +='<tr><td colspan='+colCount+' style="background: #0480be;color: white;font-size: 14pt;text-align: center">FairCert Certification Services Pvt. Ltd.</tr>';
                                tempRows +='<tr><td colspan='+colCount+' style="background: #0480be;color: white;font-size: 14pt;text-align: center">List OF Client</tr>';
...
})( jQuery, window, document );// JavaScript Document// JavaScript Document
