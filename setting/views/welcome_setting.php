      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href=""><i class="fa fa-bar-chart"></i> <span>SETTINGS</span></a></li>
            <li><a href="add_certification_category.php"><i class="fa fa-book"></i> <span>Add Certification Category</span></a></li>
            <li>
              <a href="add_certificate_programs.php"><i class="fa fa-plus-square"></i> <span>Add Certification Programs</span></a>
