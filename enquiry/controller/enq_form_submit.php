...
$remark='NEW ENQUIRY ADDED BY '.$_SESSION['name'];
$insertP=$obj_db->insert_enquiry_history($table,$column,$enq_id,"pending",$date,$user_id,$times,$remark,1);
//-----------------Reports------------------------//////
$table="reports_of_enquiry";
$column="enq_id,date_of_enquiry,isactive";
//$remark='NEW ENQUIRY ADDED BY '.$user_id;
$insertP=$obj_db->insert_in_report_table($table,$column,$enq_id);
//-----------------Report------------------------//////
