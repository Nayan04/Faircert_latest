...
?>
          ...
          <div class="form-group">
            <div class="col-xs-6" style="text-align:right">
              <input type="checkbox" class="minimal-red trueness" id="trueness" name="trueness" > I do hereby affirm that all information’s provided in this enquiry form are true and correct.
            </div>
