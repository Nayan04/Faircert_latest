				  ...
				  ?>
                    ...
                    <li> <i class="fa fa-envelope bg-blue"></i>
					 ...
					 echo  $d=$db->elapsedTime($times); ?> ago </span>
                          <h3 class="timeline-header"> Status Updated By Operator <a href="#" class="label-default pad"><?php echo $db->get_user_by_id($row1['created_by']); ?> </a></h3>
                        <div class="timeline-body ">
                        Change Status :-<b style="color:#C00"> <?php  echo $row1['status'] ;?></b>
                        <br/>Remark :- <?php  echo $row1['remarks'] ;?>
                        <br/>Department :- <?php  
						  $rs1=$db->get_emp_details($row1['created_by']);
						  $rss=mysql_fetch_array($rs1);
						  echo $rss['dept_name'];
						  ?><br/>Designation:- <?php echo $rss['desig_name']; ?></div>
