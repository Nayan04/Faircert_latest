...
class certificate
{
	...
	echo $sql = sprintf("update reports_of_enquiry set d_o_second_review='$dates', name_of_2nd_reviewer='$staff', id_of_second_reviewer='$staffid'  where enq_id='$enq_id' and isactive=1"); 
		            $rs=mysql_query($sql,$this->link);
		            if(!$rs){
			         echo mysql_error($this->link);
			         }else{
